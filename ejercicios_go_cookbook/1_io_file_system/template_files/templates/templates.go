...
// RunTemplate inicializa una plantilla y muestra una variedad
// de funciones auxiliares de plantilla
func RunTemplate() error {
	...
	// estos también se pueden encadenar
	t := template.New("example")
	t = t.Funcs(funcmap)

	// Podríamos usar Must en su lugar para entrar en pánico por error
	...
	// para demostrar bloques crearemos otra plantilla
	// clonando la primera plantilla y luego analizando una segunda
	t2, err := t.Clone()
	if err != nil {
		return err
	}
	...
	// escribe la plantilla para stdout y rellena
	// con datos
