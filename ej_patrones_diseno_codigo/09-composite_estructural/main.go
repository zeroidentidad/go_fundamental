...
func main() {
	...
	t1 := Task{name: "Mockup", responsable: "UI Designer", price: 2000}
	...
	t3 := Task{name: "JS", responsable: "Frontend Developer", price: 2000}
	...
	t5 := Task{name: "Database", responsable: "DBA", price: 2000}
